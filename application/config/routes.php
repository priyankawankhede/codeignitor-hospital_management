...
$route['patients/view'] = 'Patients';
$route['patients/add'] = 'Patients/add';
$route['patients/update'] = 'Patients/update';
$route['patients/delete/(:any)'] = 'Patients/delete';
$route['patients/profile/(:any)'] = 'Patients/profile';

$route['reports/view'] = 'Reports';
$route['reports/add'] = 'Reports/add';
$route['reports/view_reports/(:any)'] = 'Reports/view_report';
